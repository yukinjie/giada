...
: channelId(c.id)
, channelName(c.name)
, framesInSeq(g_sequencer.getFramesInSeq())
, framesInBeat(g_sequencer.getFramesInBeat())
, framesInBar(g_sequencer.getFramesInBar())
, framesInLoop(g_sequencer.getFramesInLoop())
